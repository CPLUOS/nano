...
h2 = ROOT.THStack("h2", "d0 mass with a cut-based")

#hbs = ROOT.TH1D("before sig", "before sig", 60, 1.7, 2.)
#hbb = ROOT.TH1D("before bkg", "before bkg", 60, 1.7, 2.)
...
for id0, d in enumerate(d0s):
    ...
    if d.cme_lxyE < 1: continue
    if d.cme_l3DE < 1: continue
    #if d.cme_mass < 1.86483-0.05 or d.cme_mass > 1.86483+0.05: continue
