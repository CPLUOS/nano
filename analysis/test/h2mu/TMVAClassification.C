...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   dataloader->AddVariable( "all_muEtaDiff", 'F' );
   dataloader->AddVariable( "all_muPtDiff", 'F' );
   dataloader->AddVariable( "all_muPhiDiff", 'F' );
   dataloader->AddVariable( "all_muDR", 'F' );
   dataloader->AddVariable( "all_Dilep_Pt", 'F' );
   dataloader->AddVariable( "all_Dilep_Eta", 'F' );
   
   //VARIABLES FOR FL CHANNEL//
   dataloader->AddVariable( "FL_lepEtaDiff", 'F' );
   dataloader->AddVariable( "FL_lepPtDiff", 'F' );
   dataloader->AddVariable( "FL_lepPhiDiff", 'F' );
   dataloader->AddVariable( "FL_lep1Pt", 'F' );
   dataloader->AddVariable( "FL_lep1Eta", 'F' );
   dataloader->AddVariable( "FL_lep2Pt", 'F' );
   dataloader->AddVariable( "FL_lep2Eta", 'F' );
   dataloader->AddVariable( "FL_lepDR", 'F' );
   dataloader->AddVariable( "FL_nJet", 'F' );
   dataloader->AddVariable( "FL_nbJet", 'F' );
