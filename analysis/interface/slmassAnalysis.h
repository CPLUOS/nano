#ifndef slmassAnalysis_H
#define slmassAnalysis_H

#include "semiLepTopAnalysis.h"

class slmassAnalysis : public semiLepTopAnalysis {
private: 
  //Varialbes
...
public :
  ...
  slmassAnalysis(TTree *tree=0, Bool_t isMC = false, Bool_t sle = false, Bool_t slm = false);
  ~slmassAnalysis();
  virtual void     Loop();
