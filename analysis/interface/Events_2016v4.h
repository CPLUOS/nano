...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         genWeight;
   UInt_t          nhad_jet;
   Float_t         had_jet_btagCMVA[55];   //[nhad_jet]
   Float_t         had_jet_btagCSVV2[55];   //[nhad_jet]
   Float_t         had_jet_btagDeepB[55];   //[nhad_jet]
   Float_t         had_jet_btagDeepC[55];   //[nhad_jet]
   Float_t         had_jet_eta[55];   //[nhad_jet]
   Float_t         had_jet_mass[55];   //[nhad_jet]
   Float_t         had_jet_phi[55];   //[nhad_jet]
   Float_t         had_jet_pt[55];   //[nhad_jet]
   UInt_t          nhad;
   Float_t         had_jetDR[55];   //[nhad]
   Float_t         had_legDR[55];   //[nhad]
   Float_t         had_diffMass[55];   //[nhad]
   Float_t         had_lxy[55];   //[nhad]
   Float_t         had_lxyErr[55];   //[nhad]
   Float_t         had_l3D[55];   //[nhad]
   Float_t         had_l3DErr[55];   //[nhad]
   Float_t         had_dca[55];   //[nhad]
   Float_t         had_angleXY[55];   //[nhad]
   Float_t         had_angleXYZ[55];   //[nhad]
   Float_t         had_dau1_chi2[55];   //[nhad]
   Float_t         had_dau1_nHits[55];   //[nhad]
   Float_t         had_dau1_pt[55];   //[nhad]
   Float_t         had_dau1_ipsigXY[55];   //[nhad]
   Float_t         had_dau1_ipsigZ[55];   //[nhad]
   Float_t         had_dau2_chi2[55];   //[nhad]
   Float_t         had_dau2_nHits[55];   //[nhad]
   Float_t         had_dau2_pt[55];   //[nhad]
   Float_t         had_dau2_ipsigXY[55];   //[nhad]
   Float_t         had_dau2_ipsigZ[55];   //[nhad]
   Int_t           had_nJet[55];   //[nhad]
   Int_t           had_nDau[55];   //[nhad]
   Int_t           had_idx[55];   //[nhad]
   Int_t           had_dau1_idx[55];   //[nhad]
   Int_t           had_dau2_idx[55];   //[nhad]
   UInt_t          nJet;
  ...
  // Int_t           Pileup_nTrueInt;
   ...
   Float_t         had_chi2[50];   //[nhad]
   Float_t         had_eta[50];   //[nhad]
   Float_t         had_mass[55];   //[nhad]
   Float_t         had_phi[55];   //[nhad]
   Float_t         had_pt[55];   //[nhad]
   Float_t         had_x[55];   //[nhad]
   Float_t         had_y[55];   //[nhad]
   Float_t         had_z[55];   //[nhad]
   Int_t           had_ndof[55];   //[nhad]
   Int_t           had_pdgId[55];   //[nhad]
