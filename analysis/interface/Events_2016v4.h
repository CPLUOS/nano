...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         genWeight;
   UInt_t          nhad_jet;
   Float_t         had_jet_btagCMVA[3000];   //[nhad_jet]
   Float_t         had_jet_btagCSVV2[3000];   //[nhad_jet]
   Float_t         had_jet_btagDeepB[3000];   //[nhad_jet]
   Float_t         had_jet_btagDeepC[3000];   //[nhad_jet]
   Float_t         had_jet_eta[3000];   //[nhad_jet]
   Float_t         had_jet_mass[3000];   //[nhad_jet]
   Float_t         had_jet_phi[3000];   //[nhad_jet]
   Float_t         had_jet_pt[3000];   //[nhad_jet]
   UInt_t          nhad;
   Float_t         had_jetDR[3000];   //[nhad]
   Float_t         had_legDR[3000];   //[nhad]
   Float_t         had_diffMass[3000];   //[nhad]
   Float_t         had_lxy[3000];   //[nhad]
   Float_t         had_lxyErr[3000];   //[nhad]
   Float_t         had_l3D[3000];   //[nhad]
   Float_t         had_l3DErr[3000];   //[nhad]
   Float_t         had_dca[3000];   //[nhad]
   Float_t         had_angleXY[3000];   //[nhad]
   Float_t         had_angleXYZ[3000];   //[nhad]
   Float_t         had_dau1_chi2[3000];   //[nhad]
   Float_t         had_dau1_nHits[3000];   //[nhad]
   Float_t         had_dau1_pt[3000];   //[nhad]
   Float_t         had_dau1_ipsigXY[3000];   //[nhad]
   Float_t         had_dau1_ipsigZ[3000];   //[nhad]
   Float_t         had_dau2_chi2[3000];   //[nhad]
   Float_t         had_dau2_nHits[3000];   //[nhad]
   Float_t         had_dau2_pt[3000];   //[nhad]
   Float_t         had_dau2_ipsigXY[3000];   //[nhad]
   Float_t         had_dau2_ipsigZ[3000];   //[nhad]
   Int_t           had_nJet[3000];   //[nhad]
   Int_t           had_nDau[3000];   //[nhad]
   Int_t           had_idx[3000];   //[nhad]
   Int_t           had_dau1_idx[3000];   //[nhad]
   Int_t           had_dau2_idx[3000];   //[nhad]
   UInt_t          nJet;
  ...
  // Int_t           Pileup_nTrueInt;
   ...
   Float_t         had_chi2[3000];   //[nhad]
   Float_t         had_eta[3000];   //[nhad]
   Float_t         had_mass[3000];   //[nhad]
   Float_t         had_phi[3000];   //[nhad]
   Float_t         had_pt[3000];   //[nhad]
   Float_t         had_x[3000];   //[nhad]
   Float_t         had_y[3000];   //[nhad]
   Float_t         had_z[3000];   //[nhad]
   Int_t           had_ndof[3000];   //[nhad]
   Int_t           had_pdgId[3000];   //[nhad]
   ...
   UInt_t          nhadTruth;
   Int_t           hadTruth_nMatched[3000];   //[nhadTruth]
   Int_t           hadTruth_nTrueDau[3000];   //[nhadTruth]
   Int_t           hadTruth_isHadFromTsb[3000];   //[nhadTruth]
   UChar_t         hadTruth_isHadFromTop[3000];   //[nhadTruth]
   UChar_t         hadTruth_isHadFromW[3000];   //[nhadTruth]
   UChar_t         hadTruth_isHadFromS[3000];   //[nhadTruth]
   UChar_t         hadTruth_isHadFromC[3000];   //[nhadTruth]
   UChar_t         hadTruth_isHadFromB[3000];   //[nhadTruth]
