...
# with command line options: run2_2016RD -s NANO -n 10 --data --eventcontent NANOAOD --datatier NANOAOD --filein file:06376BC4-273C-E711-8B48-001EC94BF0EF.root --conditions auto:run2_data_relval --era Run2_2016,run2_miniAOD_80XLegacy --customise nano/nanoAOD/nano_cff.customise --no_exec
...
#fileNames = cms.untracked.vstring('file:5E45E59B-0A97-E711-9AAB-008CFAF72A64.root'),
