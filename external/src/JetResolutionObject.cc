...
//   https://github.com/cms-sw/cmssw/blob/CMSSW_9_4_X/CondFormats/JetMETObjects/interface/JetResolutionObject.h
//   in a2f9cbb commit
// Copied by Byeonghak Ko
//


#define STANDALONE // MODIFIED - For standalone of nanoAOD analysers
...
#else
//#include "JetResolutionObject.h" // MODIFIED
//#include "Utilities.h" // MODIFIED
