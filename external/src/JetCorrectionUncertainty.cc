...
//   https://github.com/cms-sw/cmssw/blob/CMSSW_9_4_X/CondFormats/JetMETObjects/src/JetCorrectionUncertainty.cc
//   in deb815b commit
// Copied by Byeonghak Ko
//


//#include "CondFormats/JetMETObjects/interface/JetCorrectionUncertainty.h" // MODIFIED
//#include "CondFormats/JetMETObjects/interface/SimpleJetCorrectionUncertainty.h" // MODIFIED
//#include "CondFormats/JetMETObjects/interface/JetCorrectorParameters.h" // MODIFIED
#include "nano/external/interface/JetCorrectionUncertainty.h" // MODIFIED
#include "nano/external/interface/SimpleJetCorrectionUncertainty.h" // MODIFIED
#include "nano/external/interface/JetCorrectorParameters.h" // MODIFIED

//#include "FWCore/MessageLogger/interface/MessageLogger.h" // MODIFIED

//#include "Math/PtEtaPhiE4D.h" // MODIFIED
//#include "Math/Vector3D.h" // MODIFIED
//#include "Math/LorentzVector.h" // MODIFIED
#include <TLorentzVector.h> // MODIFIED
#include <TVector3.h> // MODIFIED
#include <vector>
#include <string>
...
// MODIFIED
namespace edm {
  inline std::ostream &LogError(const char *szTitle) {return std::cerr << szTitle << ": ";}
};
